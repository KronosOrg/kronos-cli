...
func addSubcommandPalettes() {
	rootCmd.AddCommand(forceWake.ForceWakeCmd)
	rootCmd.AddCommand(forceSleep.ForceSleepCmd)
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.kronos-cli.yaml)")
